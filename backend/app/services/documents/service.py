...
from app.core.mvp import normalize_mvp_language, normalize_physics_subject, require_pdf_extension
...
class DocumentService:
    ...
    async def upload_document(
        ...
        try:
            ...
            processor = DocumentProcessor(vector_store=vector_store, db_session=self.db)
