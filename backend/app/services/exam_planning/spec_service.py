...
from app.core.runtime_models import ExamSpec
from app.core.mvp import DEFAULT_OUTPUT_LANGUAGE, DEFAULT_QUESTION_TYPE
from app.services.curriculum.scope_service import ResolvedScope
