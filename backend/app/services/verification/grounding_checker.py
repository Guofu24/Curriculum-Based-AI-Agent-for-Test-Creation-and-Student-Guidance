"""
Grounding Checker â€” Hybrid Heuristic Source Verification (Phase 2)
...
1. **Per-chunk source traceability** â€” which source chunk supports the
   question stem, correct answer, and each distractor individually.
2. **Lexical overlap** â€” keyword Jaccard with Vietnamese+English stopword removal.
3. **Phrase overlap** â€” longest common subsequence (LCS) ratio to catch
   paraphrased content that word-level overlap misses.
4. **N-gram overlap** â€” character trigram Jaccard (lightweight).
5. **Correct answer support** â€” scored 0-1 (not just boolean) combining
   token overlap + phrase match against source.
6. **Per-distractor analysis** â€” individual score for each MCQ option:
   a distractor should have *some* plausibility (moderate overlap) but
   NOT be more supported than the correct answer.
7. **Verbatim detection** â€” flags questions that copy source text too
...
# â”€â”€ Stopwords (Vietnamese + English, minimal) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€

_STOPWORDS = frozenset({
    # Vietnamese
    "vÃ ", "cá»§a", "lÃ ", "cÃ³", "Ä‘Æ°á»£c", "cho", "vá»›i", "nÃ y", "Ä‘Ã³", "má»™t",
    "cÃ¡c", "nhá»¯ng", "trong", "tá»«", "ra", "khi", "Ä‘áº¿n", "Ä‘á»ƒ", "theo",
    "vá»", "cÅ©ng", "nhÆ°", "hay", "hoáº·c", "nhÆ°ng", "mÃ ", "náº¿u", "thÃ¬",
    "sáº½", "Ä‘Ã£", "Ä‘ang", "ráº¥t", "hÆ¡n", "nháº¥t", "nÃªn", "vÃ¬", "bá»Ÿi",
    "táº¡i", "do", "khÃ´ng", "cÃ²n", "láº¡i", "Ä‘Ã¢y", "nÃ o", "bá»‹", "vÃ o",
    "qua", "trÃªn", "dÆ°á»›i", "sau", "trÆ°á»›c",
    # English
...
class GroundingReport:
    ...
    slot_number: int
    # â”€â”€ Aggregate scores â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    # â”€â”€ Detailed breakdowns â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
# â”€â”€ Grounding thresholds â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
class GroundingChecker:
    ...
    def check(self, question: GeneratedQuestion) -> GroundingReport:
        ...
        This is the main entry point â€” backward compatible with Phase 1.
        """
        ...
        # â”€â”€ 1. Per-chunk source traceability â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        report.source_traceability = self._trace_sources(
            question, source_texts, source_chunks,
        )

        # â”€â”€ 2. Lexical overlap (keyword Jaccard) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        report.lexical_overlap = self._lexical_overlap(
            question.content, combined_source,
        )

        # â”€â”€ 3. N-gram overlap (char trigrams) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        report.ngram_overlap = self._ngram_overlap(
            question.content, combined_source, n=3,
        )

        # â”€â”€ 4. Phrase overlap (LCS ratio vs best chunk) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        report.phrase_overlap = self._phrase_overlap_best_chunk(
            question.content, source_texts,
        )

        # â”€â”€ 5. Correct answer support (scored 0-1) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        ...
        # â”€â”€ 6. Per-distractor analysis (MCQ) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        if question.question_type == "mcq" and question.options:
            report.distractor_details, report.distractors_valid = (
                self._analyze_distractors(question, combined_source)
            )

        # â”€â”€ 7. Verbatim detection â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        ...
        # â”€â”€ Overall score â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        verbatim_penalty = (
        ...
        # â”€â”€ Append human-readable details â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    # â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”
    # 2. Lexical overlap (keyword Jaccard â€” directional)
    # â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”
