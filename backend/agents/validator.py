...
Output per question (validation_notes JSON):
    basic_rule_pass   — structural checks passed?
    grounding_pass    — grounding heuristic passed?
    grounding_report  — full GroundingReport dict (source traceability, etc.)
    validation_errors — list of human-readable issues
    overall_quality   — 0.0–1.0 composite score
